...
%>
    ...
    <script type="text/javascript" src="../../../resources/js/admin/idle/replyList.js"></script>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"><%=menuTypeName %>댓글관리</h1>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                    <c:if test="${not empty idleReplyDTOList and fn:length(idleReplyDTOList) gt 0}">
                                    	<c:forEach items="${idleReplyDTOList}" var="i">
                                   		<tr>
